...
function buildModel(product) {
  ...
  let model;
  // Apparel model building logic goes here
...
function getProductThumbnail(product) {
  return `<svg viewBox="0 0 50 50" fill="none"><path d="M18 8L8 15v30h34V15L32 8H18z" stroke="rgba(255,255,255,0.5)" stroke-width="1.5" fill="${product.color}40"/><path d="M18 8l7 7 7-7" stroke="rgba(255,255,255,0.4)" stroke-width="1"/></svg>`;
}
